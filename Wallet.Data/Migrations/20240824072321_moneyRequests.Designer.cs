...
namespace Wallet.Data.Migrations
{
    ...
    [Migration("20240824072321_moneyRequests")]
    partial class moneyRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Data.Models.AppUser", b =>
                {
                    ...
                    b.Property<int?>("LastSelectedWalletId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LastSelectedWalletId");
            ...
            modelBuilder.Entity("Wallet.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wallet.Data.Models.MoneyRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RequestedCurrency")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wallet.Data.Models.OverdraftSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DefaultConsecutiveNegativeMonths")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
                    ...
                    b.Property<decimal>("DefaultOverdraftLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
            ...
            modelBuilder.Entity("Wallet.Data.Models.UserWallet", b =>
                {
                    ...
                    b.Property<int>("ConsecutiveNegativeMonths")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wallet.Data.Models.AppUser", b =>
                {
                    b.HasOne("Wallet.Data.Models.UserWallet", "LastSelectedWallet")
                        .WithMany()
                        .HasForeignKey("LastSelectedWalletId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("LastSelectedWallet");
                });
            ...
            modelBuilder.Entity("Wallet.Data.Models.MoneyRequest", b =>
                {
                    b.HasOne("Wallet.Data.Models.AppUser", "Recipient")
                        .WithMany("ReceivedRequests")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Wallet.Data.Models.AppUser", "Requester")
            ...
            modelBuilder.Entity("Wallet.Data.Models.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("Wallet.Data.Models.Category", "Category")
